							...
							<TBODY>
								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="items/add.do" 
														target=main>－ 新增用户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="items/list.do"
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 流程管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="items/addProcess.do"
														target=main>－ 发起工单</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>

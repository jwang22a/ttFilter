  ...
  -->
		...
		cellSpacing=1 cellPadding=2 rules=all border=0>
            <tr id="asd" style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <td style="WIDTH: 12.5%">工单标题</td>
                <td style="WIDTH: 12.5%">业务系统名称 </td>
                <td style="WIDTH: 12.5%">业务系统账号</td>
                <td style="WIDTH: 12.5%">账号所属组织 </td>
                <td style="WIDTH: 12.5%">处理人姓名 </td>
                <td style="WIDTH: 12.5%">处理人工号 </td>
                <td style="WIDTH: 12.5%">操作 </td>
                <td style="WIDTH: 12.5%">原因 </td>
            </tr>
            <%-- <tr id="wsx"></tr>
    		...
    		if(window.confirm('你确定生成工单吗？')){
                //alert("确定");
			        $.ajax({
			    		type:"post",
			    		dataType: "json",
			    		url:"<%=request.getContextPath()%>/items/lockCreateProcess.do",
			    		//contentType:"application/json;charset=utf-8",
			    		contentType:"application/x-www-form-urlencoded",
			    		data:"data="+JSON.stringify(sData)+"&processName=accountLocking", 
			    		async: false,
        ...
        reader.onload = function(e) {
           ...
           /*  for(var i=0;i<fdata.length;i++){
        	...
        	for(var i=0;i<fdata.length;i++){
        		...
        		Obj.systemName=fdata[i].业务系统名称;
        		Obj.systemAccount=fdata[i].业务系统账号;
        		Obj.accountGroup=fdata[i].账号所属组织 ;
        		Obj.dealingPeople=fdata[i].处理人姓名;
        		Obj.userId=fdata[i].处理人工号 ;
        		Obj.operatoring=fdata[i].操作;
        		Obj.lockReason=fdata[i].原因 ;
        		sData.push(Obj);
             	html+="<tr style='FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none'><td style='WIDTH: 12.5%'>"+fdata[i].工单标题 +"</td>"+
                "<td style='WIDTH: 12.5%'>"+fdata[i].业务系统名称 +"</td>"+
                "<td style='WIDTH: 12.5%'>"+fdata[i].业务系统账号  +"</td>"+
                "<td style='WIDTH: 12.5%'>"+fdata[i].账号所属组织 +"</td>"+
                "<td style='WIDTH: 12.5%'>"+fdata[i].处理人姓名+"</td>"+
                "<td style='WIDTH: 12.5%'>"+fdata[i].处理人工号+"</td>"+
                "<td style='WIDTH: 12.5%'>"+fdata[i].操作+"</td>"+
                "<td style='WIDTH: 12.5%'>"+fdata[i].原因+"</td>"+
            "</tr>"
             }  

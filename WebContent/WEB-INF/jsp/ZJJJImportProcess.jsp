  ...
  -->
		...
		cellSpacing=1 cellPadding=2 rules=all border=0>
            <tr id="asd" style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <td style="WIDTH: 16.6%">工单标题</td>
                <td style="WIDTH: 16.6%">投诉人姓名 </td>
                <td style="WIDTH: 16.6%">紧急程度 </td>
                <td style="WIDTH: 16.6%">问题来源 </td>
                <td style="WIDTH: 16.6%">问题描述 </td>
                <td style="WIDTH: 16.6%">接收人姓名 </td>
            </tr>
            <%-- <tr id="wsx"></tr>
    		...
    		if(window.confirm('你确定生成工单吗？')){
                //alert("确定");
			          $.ajax({
			    		...
			    		data:"data="+JSON.stringify(sData)+"&processName=ZJJJ", 
			    		async: false,
        ...
        reader.onload = function(e) {
           ...
           /*  for(var i=0;i<fdata.length;i++){
        	...
        	for(var i=0;i<fdata.length;i++){
        		...
        		Obj.COMPLAINANT=fdata[i].投诉人姓名;
        		Obj.SLEVEL=fdata[i].紧急程度;
        		Obj.PROBLEMSOURCE=fdata[i].问题来源 ;
        		Obj.HANDOVERCONTENT=fdata[i].问题描述;
        		Obj.HANDOVERPERSON=fdata[i].接收人姓名 ;
        		sData.push(Obj);
             	html+="<tr style='FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none'><td style='WIDTH: 16.6%'>"+fdata[i].工单标题 +"</td>"+
                "<td style='WIDTH: 16.6%'>"+fdata[i].投诉人姓名 +"</td>"+
                "<td style='WIDTH: 16.6%'>"+fdata[i].紧急程度  +"</td>"+
                "<td style='WIDTH: 16.6%'>"+fdata[i].问题来源 +"</td>"+
                "<td style='WIDTH: 16.6%'>"+fdata[i].问题描述+"</td>"+
                "<td style='WIDTH: 16.6%'>"+fdata[i].接收人姓名+"</td>"+
            "</tr>"
             }  
